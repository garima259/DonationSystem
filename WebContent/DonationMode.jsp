...
<body>
<form action="./DonationMode" method="post">
		
		<h1>Select Mode of Donation</h1> <select name="ngoList">
		...
		<br>
		<button input type="submit" name="modeOfDonation" value="modeOfDonation"
