...
<body style="opacity: 0.5; filter: alpha(opacity = 50);" >
<form action="./AddOrRemoveNgo" method="post">
		<h1>Umeed</h1>
		<h3>Enter Ngo Name</h3>
		<input type="text" name="removeNgoName" value=""><br> <br>
		<button input type="submit" name="removeNgo" value="submit"
			style="margin-left: 350px;">Remove Ngo</button><br><br>
			</form>
</body>
</html>
